...
- `React Pose` Animations in react are hard enough. Everything that encourages using them is great as they should be first class citizen in modern software. More than that it uses FLIP technique and direct DOM manipulation. We all love 60 fps, right?
