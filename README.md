...
- `React Pose` Animations in react are hard enough. Everything that encourages using them is great as they should be the first class citizen in modern UI. More than that it uses FLIP technique and direct DOM manipulation. We all love 60 fps, right?
