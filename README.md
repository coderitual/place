...
- `React Pose` Animations in react are hard enough. Everything that encourages their use is great. More than that it uses FLIP technique and direct DOM manipulation -> 60 fps
