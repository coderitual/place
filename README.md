...
Each library was picked carefully based on application needs to satisfy real world requirements but nothing more. Feel free to replace them with an alternatives if you need it.
